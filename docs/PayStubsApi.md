...
|------------- | ------------- | -------------|
| [**getDetails**](PayStubsApi.md#getDetails) | **GET** /paystub | Retrieve my pay stubs |


<a name="getDetails"></a>
# **getDetails**
> Object getDetails().execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PayStubsApi#getDetails");
