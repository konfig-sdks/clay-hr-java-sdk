...
|------------- | ------------- | -------------|
| [**getAssignments**](PerformanceReviewAssignmentApi.md#getAssignments) | **GET** /appraisal/assignment | Retrieve Performance Review Assignments |


<a name="getAssignments"></a>
# **getAssignments**
> Object getAssignments().execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PerformanceReviewAssignmentApi#getAssignments");
