...
|------------- | ------------- | -------------|
| [**getAccessToken**](AuthenticationApi.md#getAccessToken) | **GET** /api/token | Get Access Token for Authentication |


<a name="getAccessToken"></a>
# **getAccessToken**
> AuthenticationGetAccessTokenResponse getAccessToken().execute();
