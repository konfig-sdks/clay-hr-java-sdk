...
public class AuthenticationApiGenerated {
    ...
    private ApiResponse<AuthenticationGetAccessTokenResponse> getAccessTokenWithHttpInfo() throws ApiException {
    ...
    private okhttp3.Call getAccessTokenAsync(final ApiCallback<AuthenticationGetAccessTokenResponse> _callback) throws ApiException {
    ...
    public class GetAccessTokenRequestBuilder {
        ...
        public AuthenticationGetAccessTokenResponse execute() throws ApiException {
            ApiResponse<AuthenticationGetAccessTokenResponse> localVarResp = getAccessTokenWithHttpInfo();
