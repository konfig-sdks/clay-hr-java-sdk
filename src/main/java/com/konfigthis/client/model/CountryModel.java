...
public class CountryModel {
  ...
  public CountryModel countryId(Integer countryId) {
  ...
  **/
  ...
  public CountryModel countryName(String countryName) {
  ...
  **/
  ...
  public CountryModel iso2(String iso2) {
  ...
  **/
   ...
   * @return the CountryModel instance itself
   */
  public CountryModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.countryId, countryModel.countryId) &&
        Objects.equals(this.countryName, countryModel.countryName) &&
        Objects.equals(this.iso2, countryModel.iso2)&&
        Objects.equals(this.additionalProperties, countryModel.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CountryModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CountryModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CountryModel>() {
           ...
           public CountryModel read(JsonReader in) throws IOException {
             ...
             CountryModel instance = thisAdapter.fromJsonTree(jsonObj);
