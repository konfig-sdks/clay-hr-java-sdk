...
import com.konfigthis.client.model.GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListInner;
...
public class GoalsGetGoalResponseAssignedUserModelLocationModel {
  ...
  private List<GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListInner> addressModelList = null;

  public GoalsGetGoalResponseAssignedUserModelLocationModel() {
  }

  public GoalsGetGoalResponseAssignedUserModelLocationModel locationId(String locationId) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel locationName(String locationName) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel cid(String cid) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel locationDescription(String locationDescription) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel locationType(String locationType) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel address(String address) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel lattitude(String lattitude) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel longitude(String longitude) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel locationUID(String locationUID) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel status(String status) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel workingDays(String workingDays) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel locationCode(String locationCode) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel locationLabel(String locationLabel) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel parentLocationId(String parentLocationId) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel createuserid(String createuserid) {
  ...
  **/
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel addressModelList(List<GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListInner> addressModelList) {
  ...
  public GoalsGetGoalResponseAssignedUserModelLocationModel addAddressModelListItem(GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListInner addressModelListItem) {
  ...
  **/
  ...
  public List<GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListInner> getAddressModelList() {
    return addressModelList;
  }


  public void setAddressModelList(List<GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListInner> addressModelList) {
   ...
   * @return the GoalsGetGoalResponseAssignedUserModelLocationModel instance itself
   */
  public GoalsGetGoalResponseAssignedUserModelLocationModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GoalsGetGoalResponseAssignedUserModelLocationModel goalsGetGoalResponseAssignedUserModelLocationModel = (GoalsGetGoalResponseAssignedUserModelLocationModel) o;
    return Objects.equals(this.locationId, goalsGetGoalResponseAssignedUserModelLocationModel.locationId) &&
        Objects.equals(this.locationName, goalsGetGoalResponseAssignedUserModelLocationModel.locationName) &&
        Objects.equals(this.cid, goalsGetGoalResponseAssignedUserModelLocationModel.cid) &&
        Objects.equals(this.locationDescription, goalsGetGoalResponseAssignedUserModelLocationModel.locationDescription) &&
        Objects.equals(this.locationType, goalsGetGoalResponseAssignedUserModelLocationModel.locationType) &&
        Objects.equals(this.address, goalsGetGoalResponseAssignedUserModelLocationModel.address) &&
        Objects.equals(this.lattitude, goalsGetGoalResponseAssignedUserModelLocationModel.lattitude) &&
        Objects.equals(this.longitude, goalsGetGoalResponseAssignedUserModelLocationModel.longitude) &&
        Objects.equals(this.locationUID, goalsGetGoalResponseAssignedUserModelLocationModel.locationUID) &&
        Objects.equals(this.status, goalsGetGoalResponseAssignedUserModelLocationModel.status) &&
        Objects.equals(this.workingDays, goalsGetGoalResponseAssignedUserModelLocationModel.workingDays) &&
        Objects.equals(this.locationCode, goalsGetGoalResponseAssignedUserModelLocationModel.locationCode) &&
        Objects.equals(this.locationLabel, goalsGetGoalResponseAssignedUserModelLocationModel.locationLabel) &&
        Objects.equals(this.parentLocationId, goalsGetGoalResponseAssignedUserModelLocationModel.parentLocationId) &&
        Objects.equals(this.createuserid, goalsGetGoalResponseAssignedUserModelLocationModel.createuserid) &&
        Objects.equals(this.addressModelList, goalsGetGoalResponseAssignedUserModelLocationModel.addressModelList)&&
        Objects.equals(this.additionalProperties, goalsGetGoalResponseAssignedUserModelLocationModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoalsGetGoalResponseAssignedUserModelLocationModel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GoalsGetGoalResponseAssignedUserModelLocationModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GoalsGetGoalResponseAssignedUserModelLocationModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoalsGetGoalResponseAssignedUserModelLocationModel is not found in the empty JSON string", GoalsGetGoalResponseAssignedUserModelLocationModel.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("addressModelList") != null && !jsonObj.get("addressModelList").isJsonNull()) {
        ...
        if (jsonArrayaddressModelList != null) {
          ...
          for (int i = 0; i < jsonArrayaddressModelList.size(); i++) {
            GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListInner.validateJsonObject(jsonArrayaddressModelList.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoalsGetGoalResponseAssignedUserModelLocationModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoalsGetGoalResponseAssignedUserModelLocationModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoalsGetGoalResponseAssignedUserModelLocationModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoalsGetGoalResponseAssignedUserModelLocationModel.class));

       return (TypeAdapter<T>) new TypeAdapter<GoalsGetGoalResponseAssignedUserModelLocationModel>() {
           @Override
           public void write(JsonWriter out, GoalsGetGoalResponseAssignedUserModelLocationModel value) throws IOException {
           ...
           @Override
           public GoalsGetGoalResponseAssignedUserModelLocationModel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GoalsGetGoalResponseAssignedUserModelLocationModel instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GoalsGetGoalResponseAssignedUserModelLocationModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GoalsGetGoalResponseAssignedUserModelLocationModel
  * @throws IOException if the JSON string is invalid with respect to GoalsGetGoalResponseAssignedUserModelLocationModel
  */
  public static GoalsGetGoalResponseAssignedUserModelLocationModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoalsGetGoalResponseAssignedUserModelLocationModel.class);
  }

 /**
  * Convert an instance of GoalsGetGoalResponseAssignedUserModelLocationModel to an JSON string
  *
  * @return JSON string
  */
