...
public class GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel {
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel() {
  }

  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel cid(String cid) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel profileId(String profileId) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel profileName(String profileName) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel profileDescription(String profileDescription) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel orgId(String orgId) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel profileResponsibilities(String profileResponsibilities) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel profileRequirements(String profileRequirements) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel salaryBandMin(String salaryBandMin) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel salaryBandMax(String salaryBandMax) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel salaryBandCurrency(String salaryBandCurrency) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel managerProfileId(String managerProfileId) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel managerProfileName(String managerProfileName) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel customFieldValueModelList(String customFieldValueModelList) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel numberofUsers(String numberofUsers) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel createuserid(String createuserid) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel status(String status) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel careerPathwayModelList(String careerPathwayModelList) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel objectType(String objectType) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel objectName(String objectName) {
  ...
  **/
  ...
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel objectid(String objectid) {
  ...
  **/
   ...
   * @return the GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel instance itself
   */
  public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel = (GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel) o;
    return Objects.equals(this.cid, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.cid) &&
        Objects.equals(this.profileId, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.profileId) &&
        Objects.equals(this.profileName, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.profileName) &&
        Objects.equals(this.profileDescription, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.profileDescription) &&
        Objects.equals(this.orgId, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.orgId) &&
        Objects.equals(this.profileResponsibilities, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.profileResponsibilities) &&
        Objects.equals(this.profileRequirements, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.profileRequirements) &&
        Objects.equals(this.salaryBandMin, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.salaryBandMin) &&
        Objects.equals(this.salaryBandMax, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.salaryBandMax) &&
        Objects.equals(this.salaryBandCurrency, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.salaryBandCurrency) &&
        Objects.equals(this.managerProfileId, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.managerProfileId) &&
        Objects.equals(this.managerProfileName, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.managerProfileName) &&
        Objects.equals(this.customFieldValueModelList, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.customFieldValueModelList) &&
        Objects.equals(this.numberofUsers, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.numberofUsers) &&
        Objects.equals(this.createuserid, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.createuserid) &&
        Objects.equals(this.status, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.status) &&
        Objects.equals(this.careerPathwayModelList, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.careerPathwayModelList) &&
        Objects.equals(this.objectType, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.objectType) &&
        Objects.equals(this.objectName, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.objectName) &&
        Objects.equals(this.objectid, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.objectid)&&
        Objects.equals(this.additionalProperties, goalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel is not found in the empty JSON string", GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.class));

       return (TypeAdapter<T>) new TypeAdapter<GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel>() {
           @Override
           public void write(JsonWriter out, GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel value) throws IOException {
           ...
           @Override
           public GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel
  * @throws IOException if the JSON string is invalid with respect to GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel
  */
  public static GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel.class);
  }

 /**
  * Convert an instance of GoalsGetGoalResponseGoalCollaborationModelInnerUserModelUserProfileModel to an JSON string
  *
  * @return JSON string
  */
