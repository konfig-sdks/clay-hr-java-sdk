...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://acmecompany.bizmerlin.net/rm/api";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("sec0", new ApiKeyAuth("header", "x-api-key"));
        authentications.put("sec1", new ApiKeyAuth("header", "userid"));
        ...
        if (configuration != null) {
            ...
            if (configuration.sec1 != null) {
                this.setSec1(configuration.sec1);
            }
    ...
    public String getSec1() {
        return ((ApiKeyAuth) this.getAuthentication("sec1")).getApiKey();
    }

    public void setSec1(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("sec1")).setApiKey(apiKey);
    }

    public void setSec1Prefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("sec1")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://acmecompany.bizmerlin.net/rm/api)
